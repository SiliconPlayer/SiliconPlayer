...
public:
    ...
    std::string getXmpFormatName();
    std::string getXmpSongMessage();
    std::string getXmpModuleMd5();
    std::string getXmpMixerName();
    int getXmpChannelCount();
    int getXmpOrderCount();
    int getXmpPatternCount();
    int getXmpTrackCount();
    int getXmpInstrumentCount();
    int getXmpSampleCount();
    int getXmpInitialSpeed();
    int getXmpInitialBpm();
    int getXmpRestartPosition();
    int getXmpCurrentOrder();
    int getXmpCurrentPattern();
    int getXmpCurrentRow();
    int getXmpCurrentTick();
